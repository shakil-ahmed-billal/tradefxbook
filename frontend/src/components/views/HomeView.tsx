...
export const HomeView: React.FC<HomeViewProps> = ({
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-200">
      ...
      {/* HERO BANNER */}
      <div className="relative overflow-hidden bg-[var(--bg-panel)] border border-[var(--border-soft)] rounded-3xl p-6 sm:p-8 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h1 className="font-sora text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[var(--text-hi)] tracking-tight leading-tight mb-2.5">
              Welcome back, <span className="bg-gradient-to-r from-[#5aa2f2] to-[#2981eb] bg-clip-text text-transparent">{user.name}</span> 👋
            </h1>

            <p className="text-xs sm:text-sm text-[var(--text-mid)] leading-relaxed max-w-xl mb-5">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="px-4 py-2.5 bg-gradient-to-r from-[#2981eb] to-[#3a63d9] text-white rounded-xl text-xs font-bold flex items-center gap-2 shadow-lg shadow-[#2981eb]/25 hover:brightness-110 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[var(--bg-elevated)] border border-[var(--border-soft)] text-[var(--text-hi)] hover:border-[#2981eb] rounded-xl text-xs font-semibold flex items-center gap-2 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[var(--bg-elevated)] border border-[var(--border-soft)] text-[var(--text-mid)] hover:text-[var(--text-hi)] rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer"
              >
          ...
          <div className="bg-[var(--bg-elevated)] border border-[var(--border-soft)] rounded-2xl p-4 sm:p-5 backdrop-blur-md min-w-[260px] flex flex-col gap-3">
            <div className="flex items-center justify-between text-xs pb-2 border-b border-[var(--border-soft)]">
              <span className="text-[var(--text-mid)]">Net Profit / Loss</span>
              <span className={`font-mono font-bold truncate ${totalPnL >= 0 ? 'text-[#10b981]' : 'text-[#ef4444]'}`}>
                {fmt(totalPnL)}
              </span>
            </div>

            <div className="flex items-center justify-between text-xs pb-2 border-b border-[var(--border-soft)]">
              <span className="text-[var(--text-mid)]">Win Rate</span>
              <span className="font-mono font-bold text-[var(--text-hi)]">{winRate.toFixed(1)}%</span>
            </div>

            <div className="flex items-center justify-between text-xs pb-2 border-b border-[var(--border-soft)]">
              <span className="text-[var(--text-mid)]">Total Logged Trades</span>
              <span className="font-mono font-bold text-[var(--text-hi)]">{trades.length}</span>
            </div>

            <div className="flex items-center justify-between text-xs">
              <span className="text-[var(--text-mid)]">Journaled Trades</span>
              <span className="font-mono font-bold text-[#10b981]">{journaledCount} / {trades.length}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-sora text-base font-bold text-[var(--text-hi)] flex items-center gap-2">
            <Home className="w-4 h-4 text-[#5aa2f2]" />
            Workspace Modules
          </h2>
          <span className="text-xs text-[var(--text-low)]">Select a tool to start analyzing</span>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div 
            onClick={() => onNavigate('dashboard')}
            className="group bg-[var(--bg-panel)] border border-[var(--border-soft)] hover:border-[#2981eb]/50 rounded-2xl p-5 cursor-pointer transition-all hover:-translate-y-0.5 shadow-lg flex flex-col justify-between"
          >
            <div>
              ...
              <h3 className="font-sora font-semibold text-sm text-[var(--text-hi)] mb-1 group-hover:text-[#5aa2f2] transition-colors">
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border-soft)] flex items-center justify-between text-xs font-semibold text-[#5aa2f2]">
          ...
          >
            <div>
              ...
              <h3 className="font-sora font-semibold text-sm text-[var(--text-hi)] mb-1 group-hover:text-[#00d9a3] transition-colors">
                Trade Journal
              </h3>
              <p className="text-xs text-[var(--text-low)] leading-relaxed">
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border-soft)] flex items-center justify-between text-xs font-semibold text-[#00d9a3]">
          ...
          <div 
            ...
            className="group bg-[var(--bg-panel)] border border-[var(--border-soft)] hover:border-[#a78bfa]/50 rounded-2xl p-5 cursor-pointer transition-all hover:-translate-y-0.5 shadow-lg flex flex-col justify-between"
          >
            <div>
              ...
              <div className="flex items-center gap-1.5 mb-1">
                <h3 className="font-sora font-semibold text-sm text-[var(--text-hi)] group-hover:text-[#a78bfa] transition-colors">
                  AI Trade Assistant
                </h3>
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border-soft)] flex items-center justify-between text-xs font-semibold text-[#a78bfa]">
          ...
          <div 
            ...
            className="group bg-[var(--bg-panel)] border border-[var(--border-soft)] hover:border-[#f2b84b]/50 rounded-2xl p-5 cursor-pointer transition-all hover:-translate-y-0.5 shadow-lg flex flex-col justify-between"
          >
            <div>
              ...
              <div className="flex items-center gap-1.5 mb-1">
                <h3 className="font-sora font-semibold text-sm text-[var(--text-hi)] group-hover:text-[#f2b84b] transition-colors">
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border-soft)] flex items-center justify-between text-xs font-semibold text-[#f2b84b]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-[var(--bg-panel)] border border-[var(--border-soft)] rounded-2xl p-6 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-sora font-bold text-base text-[var(--text-hi)] flex items-center gap-2">
                <Briefcase className="w-4 h-4 text-[#5aa2f2]" />
                Recent Executed Trades
              </h3>
              <p className="text-xs text-[var(--text-low)]">Latest positions recorded in your desk log</p>
            </div>
