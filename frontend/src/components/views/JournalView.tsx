...
export const JournalView: React.FC<JournalViewProps> = ({
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-[328px_1fr] gap-[20px] items-start animate-in fade-in duration-200">
      ...
      {/* TRADE LIST SIDEBAR */}
      <div className="bg-[var(--bg-panel)] border border-[var(--border-soft)] rounded-2xl overflow-hidden w-full flex flex-col lg:sticky lg:top-[80px] h-[calc(100vh-100px)] shadow-lg">
