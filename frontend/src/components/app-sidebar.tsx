...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="icon" {...props} className="border-r border-[#232a3a] bg-[#10141d]">
      <div className="flex flex-col h-full bg-gradient-to-b from-[#10141d] to-[#0a0d14] p-6">
