...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  const getPageTitle = (tab: NavTab) => {
    switch (tab) {
      ...
      case 'trade-analysis': return 'Trade Analysis';
      case 'market': return 'Market Overview';
      case 'ai-report': return 'AI Trade Report';
      case 'backtesting': return 'Strategy Backtesting';
      case 'traders-lounge': return 'Traders Lounge';
      case 'tools': return 'Trader Tools';
      case 'settings': return 'Settings';
      case 'help': return 'Help & Support';
      case 'auth': return 'Sign In';
      default: return 'TradeFXBook';
    }
  };
